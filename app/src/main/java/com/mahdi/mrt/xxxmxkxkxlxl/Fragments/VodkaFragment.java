 ...
 */
public class VodkaFragment extends Fragment implements AsyncResponse {
    final static String url = "http://mrtaskhim.ir/bazar/vodka.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageLoader.getInstance().init( UILConfig.config(VodkaFragment.this.getActivity()));

        PostResponseAsyncTask taskRead = new PostResponseAsyncTask(VodkaFragment.this.getActivity(), this);
    ...
    public void processFinish(String s) {
        ...
        dic.addBaseField(R.id.btnCart).onClick(new ItemClickListener() {
            ...
            public void onClick(Object item, int position, View view) {
                ...
                PostResponseAsyncTask insertTask = new PostResponseAsyncTask(
                        VodkaFragment.this.getActivity(), postData, new AsyncResponse() {
                    @Override
                    public void processFinish(String s) {
                       // Log.d(LOG, s);
                        ...
                        if(s.contains("success"))
                        {
                            ...
                            Toast.makeText(VodkaFragment.this.getActivity(), "به سبد خرید اضافه شد", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        adapter = new FunDapter<>(VodkaFragment.this.getActivity(), productList, R.layout.product_row, dic);
