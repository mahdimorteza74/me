 ...
 */
public class RumFragment extends Fragment implements AsyncResponse {
    final static String url = "http://mrtaskhim.ir/bazar/rum.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate( R.layout.fragment_rum, container, false);

        ImageLoader.getInstance().init( UILConfig.config(RumFragment.this.getActivity()));

        PostResponseAsyncTask taskRead = new PostResponseAsyncTask(RumFragment.this.getActivity(), this);
    ...
    public void processFinish(String s) {
        ...
        dic.addBaseField(R.id.btnCart).onClick(new ItemClickListener() {
            ...
            public void onClick(Object item, int position, View view) {
                ...
                PostResponseAsyncTask insertTask = new PostResponseAsyncTask(
                        RumFragment.this.getActivity(), postData, new AsyncResponse() {
                    @Override
                    public void processFinish(String s) {
                       // Log.d(LOG, s);
                        ...
                        if(s.contains("success"))
                        {
                            ...
                            Toast.makeText(RumFragment.this.getActivity(), "Added to Cart", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        adapter = new FunDapter<>(RumFragment.this.getActivity(), productList, R.layout.product_row, dic);
