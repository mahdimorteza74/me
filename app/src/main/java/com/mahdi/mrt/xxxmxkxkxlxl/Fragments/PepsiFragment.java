 ...
 */
public class PepsiFragment extends Fragment implements AsyncResponse{

    final static String url = "http://mrtaskhim.ir/bazar/pepsi.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageLoader.getInstance().init( UILConfig.config(PepsiFragment.this.getActivity()));

        PostResponseAsyncTask taskRead = new PostResponseAsyncTask(PepsiFragment.this.getActivity(), this);
    ...
    public void processFinish(String s) {
        ...
        dic.addBaseField(R.id.btnCart).onClick(new ItemClickListener() {
            ...
            public void onClick(Object item, int position, View view) {
                ...
                PostResponseAsyncTask insertTask = new PostResponseAsyncTask(
                        PepsiFragment.this.getActivity(), postData, new AsyncResponse() {
                    @Override
                    public void processFinish(String s) {
                        // Log.d(LOG, s);
                        ...
                        if(s.contains("success"))
                        {
                            ...
                            Toast.makeText(PepsiFragment.this.getActivity(), "Added to Cart", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        adapter = new FunDapter<>(PepsiFragment.this.getActivity(), productList, R.layout.product_row, dic);
