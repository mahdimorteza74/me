 ...
 */
public class CokeFragment extends Fragment implements AsyncResponse {

    final static String url = "http://mrtaskhim.ir/bazar/coke.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageLoader.getInstance().init( UILConfig.config(CokeFragment.this.getActivity()));

        PostResponseAsyncTask taskRead = new PostResponseAsyncTask(CokeFragment.this.getActivity(), this);
    ...
    public void processFinish(String s) {
        ...
        dic.addBaseField(R.id.btnCart).onClick(new ItemClickListener() {
            ...
            public void onClick(Object item, int position, View view) {
                ...
                PostResponseAsyncTask insertTask = new PostResponseAsyncTask(
                        CokeFragment.this.getActivity(), postData, new AsyncResponse() {
                    @Override
                    public void processFinish(String s) {
                        // Log.d(LOG, s);
                        ...
                        if(s.contains("success"))
                        {
                            ...
                            Toast.makeText(CokeFragment.this.getActivity(), "Added to Cart", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        adapter = new FunDapter<>(CokeFragment.this.getActivity(), productList, R.layout.product_row, dic);
