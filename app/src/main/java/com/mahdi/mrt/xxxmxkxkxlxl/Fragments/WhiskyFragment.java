 ...
 */
public class WhiskyFragment extends Fragment implements AsyncResponse {
    final static String url = "http://mrtaskhim.ir/bazar/whisky.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate( R.layout.fragment_whisky, container, false);

        ImageLoader.getInstance().init( UILConfig.config(WhiskyFragment.this.getActivity()));

        PostResponseAsyncTask taskRead = new PostResponseAsyncTask(WhiskyFragment.this.getActivity(), this);
    ...
    public void processFinish(String s) {
        ...
        dic.addBaseField(R.id.btnCart).onClick(new ItemClickListener() {
            ...
            public void onClick(Object item, int position, View view) {
                ...
                PostResponseAsyncTask insertTask = new PostResponseAsyncTask(
                        WhiskyFragment.this.getActivity(), postData, new AsyncResponse() {
                    @Override
                    public void processFinish(String s) {
                       // Log.d(LOG, s);
                        ...
                        if(s.contains("success"))
                        {
                            ...
                            Toast.makeText(WhiskyFragment.this.getActivity(), "Added to Cart", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        adapter = new FunDapter<>(WhiskyFragment.this.getActivity(), productList, R.layout.product_row, dic);
