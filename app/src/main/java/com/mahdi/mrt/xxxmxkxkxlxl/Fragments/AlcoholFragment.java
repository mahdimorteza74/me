 ...
 */
public class AlcoholFragment extends android.support.v4.app.Fragment implements AsyncResponse{
    public static final String PREFS = "prefFile";

    //ImageButton beer, whisky, rum, vodka;

    final static String url = "http://mrtaskhim.ir/bazar/alcohol.php";
